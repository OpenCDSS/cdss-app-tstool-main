// ----------------------------------------------------------------------------
// readMODSIM_JDialog - editor for readMODSIM()
// ----------------------------------------------------------------------------
...
/**
readMODSIM_JDialog constructor.
@param parent JFrame class instantiating this class.
@param app_PropList Properties from the application.
@param command Command to parse.
@param tsids Time series identifiers for available time series - unused
*/
public readMODSIM_JDialog (	JFrame parent, PropList app_PropList,
				Vector command, Vector tsids, Command command_class )
{	super(parent, true);
	initialize ( parent, "Edit ReadMODSIM() Command", app_PropList,
...
{	String file = __file_JTextField.getText().trim();
	String routine = "readMODSIM_JDialog.checkInput";
	String warning = "";
...
{	__command_Vector = command;
	...
	int y = 0;
		...
		"Read all the time series from a MODSIM file, using " +
