// TSTool_UsgsNwisInstantaneous_TableModel - table model for USGS NWIS site/time series header information for TS instances.
...
public class TSTool_UsgsNwisInstantaneous_TableModel extends JWorksheet_AbstractRowTableModel<UsgsNwisSiteTimeSeriesMetadata>
{
    
/**
Data store associated with the data.
*/
private UsgsNwisInstantaneousDataStore __dataStore = null;
...
*/
public TSTool_UsgsNwisInstantaneous_TableModel ( UsgsNwisInstantaneousDataStore dataStore, List<UsgsNwisSiteTimeSeriesMetadata> data )
throws Exception
{	if ( data == null ) {
		_rows = 0;
	}
