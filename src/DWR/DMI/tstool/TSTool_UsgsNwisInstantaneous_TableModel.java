...
*/
public class TSTool_UsgsNwisInstantaneous_TableModel extends JWorksheet_AbstractRowTableModel
{
...
*/
public TSTool_UsgsNwisInstantaneous_TableModel ( UsgsNwisInstantaneousDataStore dataStore, List data )
throws Exception
{	if ( data == null ) {
		_rows = 0;
	}
