// ----------------------------------------------------------------------------
// setMax_JDialog - editor for setMax()
// ----------------------------------------------------------------------------
// Copyright:	See the COPYRIGHT file.
// ----------------------------------------------------------------------------
// History: 
//
// 16 Mar 2001	Steven A. Malers, RTi	Initial version.  Copy add_Dialog() and
//					modify.
...
{	String alias = __alias_JComboBox.getSelected();
	...
	if ( warning.length() > 0 ) {
		__error_wait = true;
		Message.printWarning ( 1, "setMax_JDialog", warning );
	}
}
...
{	__command_Vector = command;
	...
	if ( size == 0 ) {
		Message.printWarning ( 1, "setMax_JDialog.initialize",
		"You must define time series before inserting an setMax() "+
		"command." );
		response ( 0 );
	}
