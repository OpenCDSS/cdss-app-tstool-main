...
*/
public writeStateCU_JDialog (	JFrame parent, PropList app_PropList,
				Vector command, Vector tsids )
{	super(parent, true);
	initialize ( parent, "Edit writeStateCU() Command", app_PropList,
		command, tsids );
}
...
{	String file = __file_JTextField.getText().trim();
	String routine = "writeStateCU_JDialog.checkInput";
	String warning = "";
