// ----------------------------------------------------------------------------
// TSTool_HydroBase_CUPopulation_TableModel - Table Model for a Vector of
//			HydroBase_CUPopulation
// ----------------------------------------------------------------------------
...
*/
public TSTool_HydroBase_CUPopulation_TableModel ( JWorksheet worksheet,
					Vector data,
...
{	// make sure the row numbers are never sorted ...
	...
	switch (col) {
		...
		case COL_ID:		return ag.getArea_type() + "-" +
						ag.getArea_name();
...
} // End TSTool_HydroBase_CUPopulation_TableModel
