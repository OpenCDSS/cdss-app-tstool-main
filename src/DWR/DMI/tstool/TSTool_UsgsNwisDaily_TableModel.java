...
public class TSTool_UsgsNwisDaily_TableModel extends JWorksheet_AbstractRowTableModel<UsgsNwisSiteTimeSeriesMetadata>
{
...
*/
public TSTool_UsgsNwisDaily_TableModel ( UsgsNwisDailyDataStore dataStore, List<UsgsNwisSiteTimeSeriesMetadata> data )
throws Exception
{	if ( data == null ) {
		_rows = 0;
	}
