...
public class TSToolConstants {
	...
	*/
	...
	Run_CancelCommandProcessing_String = "Cancel Command Processing (wait for command to finish)",
	Run_CancelCommandProcessingKill_String = "Cancel Command Processing (interrupt processor)",
