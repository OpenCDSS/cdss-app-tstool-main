// ----------------------------------------------------------------------------
// setIncludeMissingTS_JDialog - editor for setIncludeMissingTS()
// ----------------------------------------------------------------------------
// Copyright:	See the COPYRIGHT file.
// ----------------------------------------------------------------------------
// History: 
//
// 26 Mar 2001	Steven A. Malers, RTi	Initial version (copy and modify
//					setIgnoreLEZero_Dialog).
// 2002-04-08	SAM, RTi		Clean up interface.
...
/**
setIncludeMissingTS_JDialog constructor.
@param parent JFrame class instantiating this class.
@param command Command to parse.
@param tsids Time series identifiers - not used.
*/
...
{	__command_Vector = command;
	...
	int y = 0;
		...
		"If a time series is not found (because it is not in a" +
		" database or file), a blank" ),
		0, y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
        JGUIUtil.addComponent(main_JPanel, new JLabel (
		"time series can be automatically initialized" +
		" with default values and missing data." ),
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
        JGUIUtil.addComponent(main_JPanel, new JLabel (
		"The default is to print a warning when a time series" +
		" cannot be found." ),
		0, ++y, 7, 1, 0, 0, insetsTLBR, GridBagConstraints.NONE, GridBagConstraints.WEST);
...
of the form:
<pre>
setIncludeMissingTS(true|false)
</pre>
*/
