// TSToolInstallationManager_CellRenderer - class for rendering TSToolInstallationManager data in a JWorksheet.
...
/**
This class is a cell renderer for cells in TSToolInstallationManager JWorksheets.
*/
@SuppressWarnings("serial")
public class TSToolInstallationManager_CellRenderer
extends JWorksheet_AbstractExcelCellRenderer {

	/**
	The table model for which this class will render cells.
	*/
	private TSToolInstallationManager_TableModel tableModel = null;

	/**
	Constructor.
	@param tableModel the tableModel for which to render cells.
	*/
	public TSToolInstallationManager_CellRenderer ( TSToolInstallationManager_TableModel tableModel ) {
