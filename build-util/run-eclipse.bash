...
# For now just make sure that the Java version used is 11,
# regardless of which version is installed because Java 11 has been tested.
...
if [ "$javaVersion" != "11" ]; then
  echo "Java version is not 11.  Exiting."
  exit 1
fi
...
eclipseProgram=""
if [ -e "$HOME/eclipse/java-2024-12/eclipse/eclipse" ]; then
  eclipseProgram="$HOME/eclipse/java-2024-12/eclipse/eclipse"
elif [ -e "$HOME/eclipse/java-2019-12/eclipse/eclipse" ]; then
